...
\fill[color=zzttqq,fill=zzttqq,fill opacity=0.1] (1,1) -- (2,1) -- (1.5,1.87) -- cycle;
\fill[color=zzttqq,fill=zzttqq,fill opacity=0.1] (2.5,1.87) -- (2,1) -- (1.5,1.87) -- cycle;
\draw [color=zzttqq] (1,1)-- (2,1);
\draw [color=zzttqq] (2,1)-- (1.5,1.87);
\draw [color=zzttqq] (1.5,1.87)-- (1,1);
\draw [color=zzttqq] (2.5,1.87)-- (2,1);
\draw [color=zzttqq] (2,1)-- (1.5,1.87);
\draw [color=zzttqq] (1.5,1.87)-- (2.5,1.87);
...
\draw (1.73,1.68) node[anchor=center,rotate=-60] {L$\mid$R};
\draw (1.24,1.16) node[anchor=center] {L};
\draw (2.22,1.73) node[anchor=center] {R};
